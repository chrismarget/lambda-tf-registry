...
locals {
  provider_details = {
    ...
    "0.2.0/darwin/arm64" = {
      id = "juniper/jtaf65ff9eb2b6a58813"
      sha     = "43ad8a0ab3a381d305a41f6b12f0e0f4f762c1682842aa0f0d879624922a480d"
      url     = "https://jtaf-registry.s3.amazonaws.com/terraform-provider-jtaf65ff9eb2b6a58813_0.0.0_darwin_arm64.zip"
      sha_url = "https://jtaf-registry.s3.amazonaws.com/terraform-provider-jtaf65ff9eb2b6a58813_0.0.0_SHA256SUMS"
      sig_url = "https://jtaf-registry.s3.amazonaws.com/terraform-provider-jtaf65ff9eb2b6a58813_0.0.0_SHA256SUMS.sig"
      keys = file("jtaf65ff9eb2b6a58813.keys")
    }
  }
}
...
resource "aws_dynamodb_table_item" "providers" {
  ...
  item = jsonencode({
    (aws_dynamodb_table.registry_providers.hash_key) = { S = each.value.id }
